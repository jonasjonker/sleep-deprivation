...
title: 'Patterns of performance degradation during sleep restriction of long distance
  truck drivers '
author: "Laura Bogeart, Ben De Maesschalck, Bianca Florenzi, Jonas Jonker, Nina Rank,Alexandra Stanciu, Maria Tsontak, Dries Vrijens"
output:
...
$$E(Y_{ij}) = \gamma_{0} + \gamma_{1}* \text{Days}_{ij} \tag{7}$$
...
$$Y_i \sim N(X_i\beta, Z_iDZ_i'+\Sigma_i) \tag{9}$$
...
$$\epsilon_{ij} \sim N(0,25.59^2) \tag{13}$$
