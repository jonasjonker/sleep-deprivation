...
```{r}
ggplot() +
  geom_segment(aes(yend    = sleep_coefs$Intercept - sleep_ranef$Intercept,
                   xend    = sleep_coefs$Slope     - sleep_ranef$Slope,
...
lm_min_ranef <- ggplot(sleep) +
  geom_point(aes(Days, Reaction, colour = factor(Subject)),
             show.legend = FALSE, alpha = 0 ) +
  geom_abline(data = sleep_coefs,
              aes(intercept = Intercept-sleep_ranef$Intercept,
                  slope = Slope-sleep_ranef$Slope,
                  alpha = Slope,
                  show.legend = FALSE),
              color = "darkcyan") +
  geom_abline(data = sleep_estimate,
